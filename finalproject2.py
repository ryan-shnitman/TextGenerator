...
class TextModel:
    ...
    def similarity_scores(self, other):
        ...
        scores = [word_score, word_lengths_score, stems_score, sentence_lengths_score]
        return scores
    ...
    def classify(self, source1, source2):
        ...
        weighted_sum1 = 10 * scores1[0] + 5 * scores1[1] + 7 * scores1[2] + 6 * scores1[3]
        weighted_sum2 = 10 * scores2[0] + 5 * scores2[1] + 7 * scores2[2] + 6 * scores2[3]
